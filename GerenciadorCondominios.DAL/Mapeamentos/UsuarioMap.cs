...
namespace GerenciadorCondominios.DAL.Mapeamentos
{
    public class UsuarioMap : IEntityTypeConfiguration<Usuario>
    {
        public void Configure(EntityTypeBuilder<Usuario> builder)
        {
            ...
            builder.HasMany(u => u.ProprietariosApartamentos).WithOne(u => u.Proprietario);//muitos->umProprietario
            builder.HasMany(u => u.MoradoresApartamentos).WithOne(u => u.Morador);//muitos->um
            builder.HasMany(u => u.Veiculos).WithOne(u => u.Usuario);//muitos->um
